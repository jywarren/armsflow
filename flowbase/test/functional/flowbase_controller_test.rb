...
require 'flowbase_controller'

# Re-raise errors caught by the controller.
class FlowbaseController; def rescue_action(e) raise e end; end

class FlowbaseControllerTest < Test::Unit::TestCase
  fixtures :transfers

  def setup
    @controller = FlowbaseController.new
